export default input => {
  ...
  while(transfers.length){
    ...
    if(locationValues.length === 2){
      // If this location will compare 17 and 61, then we have solved the puzzle - return the location
      if(locationValues.includes(17) && locationValues.includes(61)) return location
